  ...
  ;($.activmap = {
    ...
    activmap: function (settings) {
      var s = $.extend({}, $.activmap.defaults, settings),
        ...
        ;(s.mapType != 'satellite' && s.mapType != 'perspective') || (mapTypeId = google.maps.MapTypeId.HYBRID)
      ...
      s.mapType == 'perspective' && map.setTilt(45)
      ...
      s.showPanel
                ? (s.posPanel == 'left' &&
                      (activmap_places.css({ left: -cont_w, right: 'auto' }), activmap_canvas.css({
                        float: 'right'
                      })), s.posPanel == 'right' &&
                      (activmap_places.css({ right: -cont_w, left: 'auto' }), activmap_canvas.css({ float: 'left' })))
                : activmap_places.hide(), $('input[name="activmap_radius"]').length &&
                $('input[name="activmap_radius"]').prop('checked', !1).each(function () {
                  ...
                  if (
                    ($.each(s.places, function (e, a) {
                      ...
                      void 0 != a.img &&
                            a.img != '' &&
                            (i +=
                                '<div class="activmap-brand"><img src="' +
                                a.img +
                                '"></div>'), 
                                (i += '<div class="activmap-details"><h4 class="activmap-title">' + a.title + '</h4>'), 
                                void 0 != a.address && a.address != '' && (i += '<div class="activmap-address">' + a.address + '</div>'), 
                                void 0 != a.phone && a.phone != '' && (i += '<div class="activmap-phone">' + a.phone + '</div>'), 
                                void 0 != a.url && a.url != '' && (i += '<div><a href="' + a.url + '" target="_blank" class="activmap-url">' + 
                                'TRACK REALTIME'+ '</a></div>'),(i += '<div><a href="' + a.t_url + '" target="_blank" class="activmap-url">' + 
                                'VIEW TRAIL HISTORY'+ '</a></div>'), (i += '</div><div style="clear: both;"></div></div>'),
                                 
                                (infoWindow[e] = new google.maps.InfoWindow({ content: i, position: t })), google.maps.event.addListener(
                            infoWindow[e],
                            'closeclick',
                            function () {
                          ...
                          opendInfoWindow != null &&
                                opendInfoWindow.close(), infoWindow[e].open(map, n), map.setCenter(n.getPosition())
                          var a = _paddedBounds(20, 280, 50, 50)
                          map.fitBounds(
                                a
                            ), (opendInfoWindow = infoWindow[e]), $('.activmap-place').removeClass('active'), $('#activmap-place_' + e).addClass('active'), activmap_places.scrollTop(activmap_places.scrollTop() + $('#activmap-place_' + e).position().top)
                        }), n.setVisible(
                            !1
                        ), (a.marker = n), markers.push(n), (a.html = '<div class="activmap-place" id="activmap-place_' + e + '"><h3>' + a.title + '</h3><p>' + a.address + '</p></div>'), $.each(
                            a.tags,
                            function (e, t) {
                        ...
                        })), centerMarker.setVisible(!0), markers.push(centerMarker), _order(), s.autogeolocate == 1 &&
                        _geolocate(), $('#activmap-geolocate').length &&
                        $('#activmap-geolocate').on('click', function () {
                          _geolocate()
                        }), $('#activmap-target').length &&
                        $('#activmap-target').on('click', function () {
                          ;(latlng = init_latlng), _update_places_bounds(), _update_map()
                        }), $('#activmap-location').length)
                ) {
                    if (s.country !== null) { var e = { types: s.locationTypes, componentRestrictions: { country: s.country } } } else var e = { types: s.locationTypes }
                    ...
                    ;(autocomplete = new google.maps.places.Autocomplete(
                      ...
                      var e = autocomplete.getPlace()
                        ;(latlng = e.geometry.location), $('.activmap-place').length && _order(), $(
                  ...
                  $('input[name="activmap_radius"]').on('change', function () {
                    ...
                    return $('input[name="marker_type[]"]').prop(
                        'checked',
                        !1
                    ), $('select[name="marker_type[]"] > option').prop('selected', !1), $(
                        'input[name="marker_type[]"], select[name="marker_type[]"]'
                    ).each(function () {
                      _update_places_tag($(this), !1)
                  ...
                  }), $('input[name="marker_type[]"]:checked')
                    .add($('select[name="marker_type[]"]').prop('selected', !0))
                    .each(function () {
                      _update_places_tag($(this), !1)
                    }), _update_map()
                  ...
                  navigator.geolocation
                    ? ((browserSupportFlag = !0), navigator.geolocation.getCurrentPosition(
                          function (e) {
                            ;(initialLocation = new google.maps.LatLng(
                                  e.coords.latitude,
                                  e.coords.longitude
                              )), (latlng = initialLocation), $('.activmap-place').length && _order(), $(
                                  'input[name="marker_type[]"], select[name="marker_type[]"]'
                              ).each(function () {
                                _update_places_tag($(this), !1)
                              }), _update_center_marker(), _update_map()
                  ...
                  e == 1
                    ? (console.log('Geolocation service failed.'), (initialLocation = latlng))
                    : (console.log(
                          "Your browser doesn't support geolocation."
                      ), (initialLocation = latlng)), map.setCenter(initialLocation)
                }), (_rad = function (e) {
                  ...
                  var t = s.unit == 'km' ? 6378137 : 3963190,
                    o = _rad(a.lat() - e.lat()),
                    n = _rad(a.lng() - e.lng()),
                    i =
                        Math.sin(o / 2) * Math.sin(o / 2) +
                        Math.cos(_rad(e.lat())) * Math.cos(_rad(a.lat())) * Math.sin(n / 2) * Math.sin(n / 2),
                    p = 2 * Math.atan2(Math.sqrt(i), Math.sqrt(1 - i)),
                    c = t * p
                  return c
                }), (_update_map = function () {
                  ;(map_w = $('#activmap-wrapper').width()), (cont_w = activmap_places.outerWidth()), num_places > 0
                    ? old_results == 0
                          ? s.showPanel &&
                                (s.posPanel == 'left' &&
                                    activmap_places.stop(!0, !0).animate({ left: 0 }, 400), s.posPanel == 'right' &&
                                    activmap_places.stop(!0, !0).animate({ right: 0 }, 400), activmap_places.is(
                                    ':visible'
                                ) && activmap_canvas.animate({ width: map_w - cont_w }, 400))
                          : s.showPanel && activmap_places.is(':visible') && $(window).width() + 17 > 1190
                                ? activmap_canvas.width(map_w - cont_w)
                                : activmap_canvas.width(map_w)
                    : (opendInfoWindow != null && opendInfoWindow.close(), s.showPanel &&
                          activmap_places.is(':visible') &&
                          $(window).width() + 17 > 1190
                          ? (activmap_canvas.animate({ width: map_w }, 400), s.posPanel == 'left' &&
                                activmap_places.animate({ left: -cont_w }, 400), s.posPanel == 'right' &&
                                activmap_places.animate({ right: -cont_w }, 400))
                          : activmap_canvas.width(map_w)), (old_results = num_places), setTimeout('_map_resize()', 400)
              ...
              $.each(s.places, function (a, t) {
                t.isVisible == 1 && (bounds.extend(t.marker.getPosition()), e++)
              }), bounds.extend(centerMarker.getPosition()), (num_places = e)
            }), (_update_places_tag = function (e, a) {
              s.allowMultiSelect ||
                    (a &&
                        ($('.marker-selector').removeClass('active'), $('input[name="marker_type[]"]')
                            .not(e)
                            .prop('checked', !1), $('select[name="marker_type[]"]')
                            .not(e)
                            .find('option')
                            .prop('selected', !1)))
              var t = e.prop('tagName') == 'SELECT' ? e.prop('selected') : e.prop('checked')
              t == 1
                    ? e.parents('.marker-selector').addClass('active')
                    : e.parents('.marker-selector').removeClass('active')
              var o, n = 0, i = [], p = []
              $('input[name="marker_type[]"]:checked')
                    .add($('select[name="marker_type[]"]').prop('selected', !0))
                    .each(function () {
                      ;(o = $(
                            this
                        ).val()), o != '' && (void 0 === ids[o] && (ids[o] = []), n == 0 ? (i = $.merge([], ids[o])) : (s.request == 'strict' && (i = $.arrayIntersect(ids[o], i)), s.request == 'large' && ((p = $.merge([], ids[o])), (i = $.merge(p, i)))), n++)
                    }), opendInfoWindow != null && opendInfoWindow.close(), $.each(s.places, function (e, a) {
                      ;(a.num_tags = 0), (a.dist = 0), $.inArray(a.id, i) >= 0 ? ((a.dist = _get_distance(a.marker.position, latlng)), s.radius == 0 || a.dist <= 1e3 * s.radius ? (a.num_tags++, a.marker.setVisible(!0), (a.isVisible = !0), $('#activmap-place_' + a.id).show()) : (a.num_tags > 0 && a.num_tags--, a.num_tags == 0 && (a.marker.setVisible(!1), (a.isVisible = !1), (a.isVisible = !1), $('#activmap-place_' + a.id).hide()))) : (a.num_tags > 0 && a.num_tags--, a.num_tags == 0 && (a.marker.setVisible(!1), (a.isVisible = !1), $('#activmap-place_' + a.id).hide()))
