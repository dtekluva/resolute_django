                    ...
                    ($.each(s.places, function (e, a) {
                      ...
                      void 0 != a.img &&
                            ...
                            (i +=
                                ...
                                a.img +
                                '"></div>'), (i += '<div class="activmap-details"><h4 class="activmap-title">' + a.title + '</h4>'), void 0 != a.address && a.address != '' && (i += '<div class="activmap-address">' + a.address + '</div>'), void 0 != a.phone && a.phone != '' && (i += '<div class="activmap-phone">' + a.phone + '</div>'), void 0 != a.url && a.url != '' && (i += '<a href="' + a.url + '" target="_blank" class="activmap-url">' + 'TRACK REALTIME'+ '</a>'), (i += '</div><div style="clear: both;"></div></div>'), (infoWindow[e] = new google.maps.InfoWindow({ content: i, position: t })), google.maps.event.addListener(
                            infoWindow[e],
                            'closeclick',
                            function () {
